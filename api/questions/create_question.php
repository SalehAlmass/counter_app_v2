...
function handleCreateQuestion() {
    ...
    if (!isset($input['question']) || !isset($input['option1']) || 
    ...
    try {
        $stmt = $pdo->prepare("
            ...
            (question, option1, option2, option3, option4, correct_answer_index, 
             explanation, difficulty, time_limit_seconds, category_id) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
